    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <a href="/auth/login" className="text-gray-700 hover:text-orange-600">Iniciar Sesión</a>
              <a href="/auth/register" className="bg-orange-500 text-white px-6 py-2 rounded-lg hover:bg-orange-600 transition-colors">
                Registrarse
              </a>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex justify-center gap-4">
              <a href="/auth/register" className="bg-orange-500 text-white px-8 py-3 rounded-lg hover:bg-orange-600 transition-colors font-semibold">
                Comenzar Gratis
              </a>
              <a href="#features" className="border-2 border-orange-500 text-orange-600 px-8 py-3 rounded-lg hover:bg-orange-50 transition-colors font-semibold">
                Saber Más
              </a>
            </div>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p>© 2024 Caña y Reseña - Todos los derechos reservados</p>
        </div>
      </footer>
    </div>
  )
