      ...
      <section className="relative overflow-hidden bg-white pb-[88px] pt-[72px] radial-gradient-hero">
        <div className="container relative z-10 mx-auto max-w-[1200px] px-4">
          ...
          <div className="flex flex-wrap items-stretch justify-center gap-8">
            ...
            <div className="relative hidden h-[500px] w-[330px] shrink-0 lg:block">
              <Image 
            ...
            <div className="flex flex-col rounded-2xl border border-border bg-card p-6 shadow-soft lg:col-span-2">
              ...
              <div className="mt-4 space-y-4">
                ...
                <div className="flex items-start space-x-4">
                  <Image data-ai-hint="woman smiling" src="https://picsum.photos/seed/avatar1/40/40" alt="Avatar" width={40} height={40} className="rounded-full" />
                ...
                {/* Review 2 */}
                <div className="flex items-start space-x-4">
                  <Image data-ai-hint="man serious" src="https://picsum.photos/seed/avatar2/40/40" alt="Avatar" width={40} height={40} className="rounded-full" />
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
